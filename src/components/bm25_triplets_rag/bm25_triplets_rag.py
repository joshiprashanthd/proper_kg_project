...
class BM25TripletsRag:
    def __init__(self, vector_store_path: Path = Path("/home/sracha/proper_kg_project/src/components/bm25_triplets_rag/vector_store")):
    ...
    def run(self, entities: list[str], top_k=10) -> list[RagDocument]:
