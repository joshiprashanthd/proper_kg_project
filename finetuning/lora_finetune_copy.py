...
# Set up WandB
setup_wandb(project_name="mhqa-finetune", run_name="run-20-percentage-new")
...
# Save model locally
model.save_pretrained("mhqa-lora-20-new")
tokenizer.save_pretrained("mhqa-lora-20-new")
...
model.save_pretrained_merged("mhqa-lora-20-new", tokenizer, save_method="merged_16bit")
